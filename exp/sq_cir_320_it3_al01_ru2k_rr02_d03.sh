#!/usr/bin/env bash
python hb_train.py \
    --output_dir         save/cir_320_it3_al01_ru2k_rr02_d03 \
    --do_lower_case \
    ...
    --cir_hidden_dropout_prob            0.3 \
    --cir_attention_probs_dropout_prob   0.3 \
    --out_num_attention_heads            8 \
    --out_aux_loss_weight                0.1 \
    --out_dropout_prob                   0.3 \
    \
    --metric_name        F1 \
    --eval_every         25000 \
    --max_seq_length     448 \
    ...
    --max_grad_norm      1.0 \
    --train_num_iters_inc_every_global_step 2000 \
